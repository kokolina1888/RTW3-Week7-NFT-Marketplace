...
const sampleData = [
  ...
  },
  {
    ...
    website: "http://axieinfinity.io",
    image:
      "https://gateway.pinata.cloud/ipfs/Qmf5xvuJ88snkugH2iu2AE4kFp7e5AHtUCf2ZHakeHdTm5",
    price: "0.03ETH",
    currentlySelling: "True",
    address: "0xe81Bf5A757C4f7F82a2F23b1e59bE45c33c5b13",
  },
...
return (
  <div>
    ...
    <div className="flex flex-col mt-20 place-items-center">
      ...
      <div className="flex flex-wrap justify-between max-w-screen-xl mt-5 text-center">
